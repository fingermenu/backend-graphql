...
exports.getTableStates = undefined;
...
var getTableStatesCountMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', new _parseServerCommon.TableStateService().count(addSortOptionToCriteria(getCriteria(searchArgs, language), searchArgs.get('sortOption'), language), sessionToken));
  ...
  return function getTableStatesCountMatchCriteria(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var getTableStatesMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', new _parseServerCommon.TableStateService().search(addSortOptionToCriteria(getCriteria(searchArgs, language), searchArgs.get('sortOption'), language).merge((0, _immutable.Map)({ limit: limit, skip: skip })), sessionToken));
  ...
  return function getTableStatesMatchCriteria(_x4, _x5, _x6, _x7, _x8) {
...
var getTableStates = exports.getTableStates = function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getTableStatesCountMatchCriteria(searchArgs, sessionToken, language);
  ...
  return function getTableStates(_x9, _x10, _x11) {
