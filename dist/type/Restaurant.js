...
var getRestaurant = exports.getRestaurant = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', new _parseServerCommon.RestaurantService().read(restaurantId, (0, _immutable.Map)({ include_parentRestaurant: true, include_menus: true }), sessionToken));
  ...
  return function getRestaurant(_x, _x2) {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  return _context2.abrupt('return', _.get('websiteUrl'));
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  return _context4.abrupt('return', _.get('pin'));
...
exports.default = new _graphql.GraphQLObjectType({
  ...
  fields: {
    ...
    pin: {
      type: _graphql.GraphQLString,
      resolve: function () {
        var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(_) {
    ...
    parentRestaurant: {
      ...
      resolve: function resolve(_, args, _ref10) {
