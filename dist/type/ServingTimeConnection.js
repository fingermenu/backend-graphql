...
exports.getServingTimes = undefined;
...
var getServingTimesCountMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', new _parseServerCommon.ServingTimeService().count(addSortOptionToCriteria(getCriteria(searchArgs, ownedByUserId), searchArgs.get('sortOption')), sessionToken));
  ...
  return function getServingTimesCountMatchCriteria(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var getServingTimesMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', new _parseServerCommon.ServingTimeService().search(addSortOptionToCriteria(getCriteria(searchArgs, ownedByUserId), searchArgs.get('sortOption')).merge((0, _immutable.Map)({ limit: limit, skip: skip })), sessionToken));
  ...
  return function getServingTimesMatchCriteria(_x4, _x5, _x6, _x7, _x8) {
    return _ref2.apply(this, arguments);
  };
}();

var getServingTimes = exports.getServingTimes = function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return getServingTimesCountMatchCriteria(searchArgs, userId, sessionToken);
          ...
          case 8:
            ...
            _context3.next = 11;
            return getServingTimesMatchCriteria(searchArgs, userId, sessionToken, limit, skip);
  ...
  return function getServingTimes(_x9, _x10, _x11) {
...
exports.default = (0, _graphqlRelay.connectionDefinitions)({
  ...
  nodeType: _ServingTime2.default
});