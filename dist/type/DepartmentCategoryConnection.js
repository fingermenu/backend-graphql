...
exports.getDepartmentCategorys = undefined;
...
var getDepartmentCategorysCountMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', new _parseServerCommon.DepartmentCategoryService().count(addSortOptionToCriteria(getCriteria(searchArgs, ownedByUserId), searchArgs.get('sortOption')), sessionToken));
  ...
  return function getDepartmentCategorysCountMatchCriteria(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var getDepartmentCategorysMatchCriteria = function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', new _parseServerCommon.DepartmentCategoryService().search(addSortOptionToCriteria(getCriteria(searchArgs, ownedByUserId), searchArgs.get('sortOption')).merge((0, _immutable.Map)({ limit: limit, skip: skip })), sessionToken));
  ...
  return function getDepartmentCategorysMatchCriteria(_x4, _x5, _x6, _x7, _x8) {
    return _ref2.apply(this, arguments);
  };
}();

var getDepartmentCategorys = exports.getDepartmentCategorys = function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return getDepartmentCategorysCountMatchCriteria(searchArgs, userId, sessionToken);
          ...
          case 8:
            ...
            _context3.next = 11;
            return getDepartmentCategorysMatchCriteria(searchArgs, userId, sessionToken, limit, skip);
  ...
  return function getDepartmentCategorys(_x9, _x10, _x11) {
...
exports.default = (0, _graphqlRelay.connectionDefinitions)({
  ...
  nodeType: _DepartmentCategory2.default
});