...
var getChoiceItemPrices = exports.getChoiceItemPrices = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(searchArgs, dataLoaders, sessionToken) {
    var userId, count, _RelayHelper$getLimit, limit, skip, hasNextPage, hasPreviousPage, choiceItemPrices, indexedChoiceItemPrices, edges, firstEdge, lastEdge;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return getChoiceItemPricesCountMatchCriteria(searchArgs, userId, sessionToken);
          ...
          case 5:
            ...
            _context3.next = 9;
            return getChoiceItemPricesMatchCriteria(searchArgs, userId, sessionToken, limit, skip);
