...
export const addOrderForProvidedUser = async (
  { correlationId, customers, notes, restaurantId, tableId, details },
  user,
  dataLoaders,
  sessionToken,
) => {
...
export const updateOrder = async ({ id, customers, notes, restaurantId, tableId, details, cancelledAt, paymentGroupId }, sessionToken) => {
  if (!id) {
